...
{
    public class UserSessionDal : EntityRepositoryBase<UserSession, ApplicationDbContext>, IUserSessionDal
    {
        private readonly ApplicationDbContext _context;
        public UserSessionDal(ApplicationDbContext context) : base(context)
        {
            _context = context;
        }
