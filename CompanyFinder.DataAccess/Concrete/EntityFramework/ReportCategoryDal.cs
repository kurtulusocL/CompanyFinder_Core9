...
{
    public class ReportCategoryDal : EntityRepositoryBase<ReportCategory, ApplicationDbContext>, IReportCategoryDal
    {
        private readonly ApplicationDbContext _context;
        public ReportCategoryDal(ApplicationDbContext context) : base(context)
        {
            _context = context;
        }
