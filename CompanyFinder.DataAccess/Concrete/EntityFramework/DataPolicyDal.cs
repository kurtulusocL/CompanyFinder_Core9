...
{
    public class DataPolicyDal : EntityRepositoryBase<DataPolicy, ApplicationDbContext>, IDataPolicyDal
    {
        private readonly ApplicationDbContext _context;
        public DataPolicyDal(ApplicationDbContext context) : base(context)
        {
            _context = context;
        }
