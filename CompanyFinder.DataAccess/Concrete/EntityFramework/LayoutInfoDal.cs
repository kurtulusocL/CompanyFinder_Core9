...
{
    public class LayoutInfoDal : EntityRepositoryBase<LayoutInfo, ApplicationDbContext>, ILayoutInfoDal
    {
        private readonly ApplicationDbContext _context;
        public LayoutInfoDal(ApplicationDbContext context) : base(context)
        {
            _context = context;
        }
