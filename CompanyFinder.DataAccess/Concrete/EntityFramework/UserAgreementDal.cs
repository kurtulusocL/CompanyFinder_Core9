...
{
    public class UserAgreementDal : EntityRepositoryBase<UserAgreement, ApplicationDbContext>, IUserAgreementDal
    {
        private readonly ApplicationDbContext _context;
        public UserAgreementDal(ApplicationDbContext context) : base(context)
        {
            _context = context;
        }
