...
{
    public class SavedContentDal : EntityRepositoryBase<SavedContent, ApplicationDbContext>, ISavedContentDal
    {
        private readonly ApplicationDbContext _context;
        public SavedContentDal(ApplicationDbContext context) : base(context)
        {
            _context = context;
        }
