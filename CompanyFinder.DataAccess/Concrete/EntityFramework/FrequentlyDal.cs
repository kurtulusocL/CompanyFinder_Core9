...
{
    public class FrequentlyDal : EntityRepositoryBase<Frequently, ApplicationDbContext>, IFrequentlyDal
    {
        private readonly ApplicationDbContext _context;
        public FrequentlyDal(ApplicationDbContext context) : base(context)
        {
            _context = context;
        }
