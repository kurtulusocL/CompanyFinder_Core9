...
{
    public class CompanyCategoryDal : EntityRepositoryBase<CompanyCategory, ApplicationDbContext>, ICompanyCategoryDal
    {
        private readonly ApplicationDbContext _context;
        public CompanyCategoryDal(ApplicationDbContext context) : base(context)
        {
            _context = context;
        }
