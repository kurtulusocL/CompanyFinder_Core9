...
{
    public class BlackListDal : EntityRepositoryBase<BlackList, ApplicationDbContext>, IBlackListDal
    {
        private readonly ApplicationDbContext _context;
        public BlackListDal(ApplicationDbContext context) : base(context)
        {
            _context = context;
        }
