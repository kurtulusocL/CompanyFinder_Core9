...
namespace CompanyFinder.DataAccess.Migrations
{
    ...
    [Migration("20250608151511_init41")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompanyFinder.Entities.Entities.CompanyContact", b =>
                {
                    ...
                    b.HasIndex("IsHide")
                        .HasDatabaseName("IX_CompanyContact_IsHide");
            ...
            modelBuilder.Entity("CompanyFinder.Entities.Entities.CompanyForm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_CompanyForm_CompanyId");

                    b.HasIndex("FormCategoryId")
                        .HasDatabaseName("IX_CompanyForm_FormCategoryId");

                    b.HasIndex("Id")
                        .IsUnique()
                        .HasDatabaseName("IX_CompanyForm_Id");

                    b.HasIndex("IsActive", "IsDeleted")
                        .HasDatabaseName("IX_CompanyForm_IsActive_IsDeleted");

                    b.ToTable("CompanyForms");
                });

            modelBuilder.Entity("CompanyFinder.Entities.Entities.CompanyFormAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CompanyFormId")
                        .HasDatabaseName("IX_CompanyFormAnswer_CompanyFormId");

                    b.HasIndex("Id")
                        .IsUnique()
                        .HasDatabaseName("IX_CompanyFormAnswer_Id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_CompanyFormAnswer_UserId");

                    b.HasIndex("IsActive", "IsDeleted")
                        .HasDatabaseName("IX_CompanyFormAnswer_IsActive_IsDeleted");

                    b.ToTable("CompanyFormAnswers");
                });
            ...
            modelBuilder.Entity("CompanyFinder.Entities.Entities.FormCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Id")
                        .IsUnique()
                        .HasDatabaseName("IX_FormCategory_Id");

                    b.HasIndex("IsActive", "IsDeleted")
                        .HasDatabaseName("IX_FormCategory_IsActive_IsDeleted");
            ...
            modelBuilder.Entity("CompanyFinder.Entities.Entities.Report", b =>
                {
                    ...
                    b.Property<int?>("CompanyFormAnswerId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CompanyFormAnswerId");
            ...
            modelBuilder.Entity("CompanyFinder.Entities.Entities.SectorNews", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CompanyFinder.Entities.Entities.CompanyForm", b =>
                {
                    ...
                    b.HasOne("CompanyFinder.Entities.Entities.FormCategory", "FormCategory")
                        .WithMany("CompanyForms")
            ...
            modelBuilder.Entity("CompanyFinder.Entities.Entities.CompanyFormAnswer", b =>
                {
                    b.HasOne("CompanyFinder.Entities.Entities.CompanyForm", "CompanyForm")
                        .WithMany("CompanyFormAnswers")
            ...
            modelBuilder.Entity("CompanyFinder.Entities.Entities.Hit", b =>
                {
                    ...
                    b.HasOne("CompanyFinder.Entities.Entities.SectorNews", "SectorNews")
                        .WithMany("Hits")
            ...
            modelBuilder.Entity("CompanyFinder.Entities.Entities.Report", b =>
                {
                    ...
                    b.HasOne("CompanyFinder.Entities.Entities.CompanyFormAnswer", "CompanyFormAnswer")
                        .WithMany("Reports")
                        .HasForeignKey("CompanyFormAnswerId");
                    ...
                    b.Navigation("CompanyFormAnswer");
            ...
            modelBuilder.Entity("CompanyFinder.Entities.Entities.AppUser.User", b =>
                {
                    ...
                    b.Navigation("CompanyFormAnswers");
